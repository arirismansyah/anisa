            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                            class="side-menu__icon fe fe-users"></i><span class="side-menu__label">Manage User
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ url('/teams') }}" class="slide-item"> Tim Kerja</a></li>
                        <li><a href="{{ url('/users') }}" class="slide-item"> Users</a></li>
                    </ul>
                </li>

                <li class="sub-category">
                    <h3>Alokasi Output</h3>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('/alokasi_output') }}"><i
                            class="side-menu__icon fe fe-grid"></i><span class="side-menu__label">Alokasi
                            Output</span></a>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                            class="side-menu__icon fe fe-book"></i><span class="side-menu__label">Manage Knowledge
                        </span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="{{ url('/m_qna') }}" class="slide-item"> FAQ</a></li>
                        <li><a href="{{ url('/m_knowledge') }}" class="slide-item"> Knowledge</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('/adk') }}"><i
                            class="side-menu__icon fe fe-upload"></i><span class="side-menu__label">Upload
                            ADK</span></a>
                </li>
