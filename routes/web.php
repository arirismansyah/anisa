...
use App\Http\Controllers\MOutputController;
...
Route::group(['middleware' => ['auth', 'role:Admin']], function () {
    ...
    Route::get('/alokasi_output', [AdminController::class, 'alokasi_output'])->name('alokasi_output');
        
    Route::post('/alokasi_output_totim', [MOutputController::class, 'alokasi_output_totim'])->name('alokasi_output_totim');
...
Route::group(['middleware' => ['auth', 'role:Admin|Ketua Tim']], function () {
...
Route::group(['middleware' => ['auth', 'role:Admin|Ketua Tim Umum']], function () {
