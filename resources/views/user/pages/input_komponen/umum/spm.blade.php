...
@section('content')
                ...
                <div class="page-header">
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Dispensasi SPM</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                        ...
                        <div class="panel panel-primary">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Input Dispensasi SPM</h3>
                                </div>

                                <div class="card-body">
                                    <div class="row d-flex justify-content-center">
                                        <form action="{{ url('/input_spm') }}" method="post">
                                            @csrf
                                            <div class="col">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-4 mt-4 mt-md-0">
                                                        ...
                                                        <div class="input-group">
                                                            <input required class="form-control text-end" id="input-"
                                                                value="0" name="jumlah_spm_dispensasi" type="number">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 mt-4 mt-md-0">
                                                        ...
                                                        <div class="input-group">
                                                            <input required class="form-control text-end" id="input-"
                                                                value="0" name="jumlah_spm" type="number">
                                                        </div>
                                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-primary">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Table Dispensasi SPM</h3>
                                </div>

                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="spm-table" class="table border table-bordered table-striped mg-b-0">
                                            <thead class="text-center">
                                                <tr>
                                                    <th rowspan="2">Tahun Anggaran</th>
                                                    <th colspan="2">Jumlah</th>
                                                    <th rowspan="2">Nilai Per-mil</th>
                                                    <th rowspan="2">IKPA</th>
                                                    <th rowspan="2">Action</th>
                                                </tr>
                                                <tr>
                                                    <th>SPM Dispensasi</th>
                                                    <th>SPM</th>
                                                </tr>
                                            </thead>
                                                ...
                                                @foreach ($data_spm as $spm)
                                                    @if ($spm->warning == 1)
                                                        <tr class="bg-warning-transparent">
                                                            <td>{{ $spm->tahun_anggaran }}</td>
                                                            <td>{{ $spm->jumlah_spm_dispensasi }}</td>
                                                            <td>{{ $spm->jumlah_spm }}</td>
                                                            <td>{{ $spm->nilai_permil }}</td>
                                                            <td>{{ $spm->ikpa }}</td>
                                                            <td class="text-center">
                                                                <div class="btn-list">
                                                                    <button id="warning-spm-btn"
                                                                        key_id="{{ $spm->id }}" type="button"
                                                                        class="btn btn-icon  btn-info"><i
                                                                            class="fa fa-comment"></i></button>
                                                                    @hasanyrole(['Admin'])
                                                                        <button id="add-warning-spm-btn"
                                                                            key_id="{{ $spm->id }}" type="button"
                                                                            class="btn btn-icon  btn-warning"><i
                                                                                class="fa fa-warning"></i></button>
                                                                    @endhasanyrole
                                                                    <button id="delete-spm-btn" key_id="{{ $spm->id }}"
                                        ...
                                        {{ $data_spm->links('vendor.pagination.simple-bootstrap-4') }}
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal-add-warning" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/add_warning_spm') }}" method="post">
                        @csrf
    ...
    {{-- modal-delete --}}
    <div class="modal fade" id="modal-delete-spm">
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body text-center p-4">
                    ...
                    <h4>Yakin menghapus komponen pengelolaan Dispensasi SPM ini?</h4>
                    <form action="{{ url('delete_spm') }}" method="post">
                        @csrf
...
@push('scripts')
    ...
    <script src="{{ url('js/features/dispensasi_spm.js') }}"></script>
@endpush
{{-- scripts --}}
